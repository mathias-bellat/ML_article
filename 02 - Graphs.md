...
| Name                          | ID    | Date | Algorithms | Architecture                         | Field                                            | Evaluation     | Task                    |
|:------------------------------|:------|-----:|:-----------|:-------------------------------------|:-------------------------------------------------|:---------------|:------------------------|
| Nguifo et al. 1997            | ID001 | 1997 | LEGAL      | Decision Trees and Rule Induction    | Classification (of material) and Typology        | Classification | Artefact Classification |
| O’Sullivan and Haklay 2000    | ID002 | 2000 | NA         | NA                                   | NA                                               | NA             | NA                      |
| Amigoni and Schiaffonati 2009 | ID003 | 2009 | NA         | NA                                   | NA                                               | NA             | NA                      |
...
```
    ...
    ##                          Field Evaluation   Task
    ## 1                         <NA>       <NA>   <NA>
    ## 2                         <NA>       <NA>   <NA>
    ## 4 Cognitive Archaeology;Theory     Theory Theory
    ## 5                         <NA>       <NA>   <NA>
    ## 6                         <NA>       <NA>   <NA>
    ## 7                         <NA>       <NA>   <NA>
...
```
    ...
    ##                                            journal Freq
    ## 61                                  Remote Sensing   15
    ## 35               Journal of Archaeological Science   14
    ## 54                                        PloS One   11
    ## 62                              Scientific Reports    6
    ## 38 Journal of Computer Applications in Archaeology    5
...
plot <- ggplot(data = frequency,
  ...
  geom_alluvium(aes(fill = Category),
               curve_type = "sigmoid") +
  geom_stratum(aes(fill = Category), col = "black", fill="lightgrey") +
  geom_text(stat = "stratum",
            aes(label = after_stat(stratum)), size = 4.5) +
